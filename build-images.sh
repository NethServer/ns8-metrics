...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=quay.io/prometheus/prometheus:v3.7.0 quay.io/prometheus/alertmanager:v0.28.1 docker.io/grafana/grafana:12.0.2 ghcr.io/nethserver/alert-proxy:${IMAGETAG:-latest}" \
    "${container}"
# Commit the image
