...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=quay.io/prometheus/prometheus:v3.5.3 quay.io/prometheus/alertmanager:v0.31.1 docker.io/grafana/grafana:12.4.10 ghcr.io/nethserver/alert-proxy:${IMAGETAG:-latest}" \
    "${container}"
# Commit the image
