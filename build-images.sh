...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=quay.io/prometheus/prometheus:v3.5.1 quay.io/prometheus/alertmanager:v0.30.1 docker.io/grafana/grafana:12.2.3 ghcr.io/nethserver/alert-proxy:${IMAGETAG:-latest}" \
    "${container}"
# Commit the image
